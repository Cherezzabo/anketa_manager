...
(function e(t, n, r) {
    function s(o, u) {
        ...
        APP.listener = function () {
            ...
            // Последняя проверка перед отрпавкой формы
            $('#anketa').submit(function (event) {
                var val = $('#user_name_input').val();
                var opts = $('#user_names > ul > li');
                // Проверка на рандомный ввод
                if (opts.length == 0) {
                    event.preventDefault();
                    alert("Заполните поле ФИО корректно, пожалуйста.");
                    // Проверка на не до конца заполенное поле
                } else if (opts[0].innerHTML != val) {
                    event.preventDefault();
                    alert("Заполните поле ФИО до конца, пожалуйста.");
                }
            });
